...
if(WITH_XPU_XFT)
  ...
  set(XPU_XFT_LOCAL_PATH "/liwei127/code/baidu/xpu/xft/build/xft_install/")
  set(XPU_XFT_INC_DIR "${XPU_XFT_LOCAL_PATH}/include/")
  include_directories(${XPU_XFT_INC_DIR})
  set(XPU_XFT_LIB "${XPU_XFT_LOCAL_PATH}/so/${XPU_XFT_LIB_NAME}")
endif()
